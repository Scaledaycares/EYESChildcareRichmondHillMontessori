...
function startConversation() {
    fetch('https://chatbot-for-eyes-childcare-richmond-hill-montesso-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-eyes-childcare-richmond-hill-montesso-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbzQkSMHXWrjWXiTICPtpEqmD6drFfUUczt8I2mUdIKANlE6raJwBFx7creWw8pwf5athg/exec';
